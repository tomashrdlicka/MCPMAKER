// ============================================================
// MCPMAKER Engine - Local Type Definitions
// Inlined from @mcpmaker/shared to avoid monorepo linking issues
// ============================================================
...
// --- Intelligent Playback Types (DOM Snapshot) ---
...
// --- Intelligent Playback Types (Claude Request/Response) ---
...
export type PlaybackMode = 'guided' | 'generative' | 'recovery';
...
export interface PlaybackContext {
  ...
  definedSteps: Array<{ order: number; description: string }>;
  lastError?: string;
  pastInsights?: string[];
}
...
// --- Playback Learning Log ---
// Stored per workflow+site so Claude starts with knowledge of what worked before
...
export interface PlaybackLogEntry {
  ...
  // Distilled insights from this run (generated by Claude after each playback)
  insights?: string;
}
